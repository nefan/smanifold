...
function [R,gradmu,gradV] = approxResidualF(xi,mu,V,v,B,ambient)
%
% Compute residuals of the samples xi from the geodesic spread of the
% subspace {V,v} of T_mu M.
%
% Residual are approximated i.e. no projections are computed. Instead,
% distances from the projections of the vectors Log(xi) to
% {V,v} are used
%
% R is the residual. gradmu,gradv are the gradients of R with respect mu
% and v, respectively in B,V coordinates resp. (B orth basis for Tmu M)
%
